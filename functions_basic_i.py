...
#     return 5
# print(number_of_days_in_a_week_silicon_or_triangle_sides() + number_of_military_branches())  # -->Error- not defined
...
# def add(b,c):
#     print(b+c)
# print(add(1,2) + add(2,3))  # --> error, functiond do not returnd anything.
